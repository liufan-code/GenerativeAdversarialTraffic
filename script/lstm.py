...
# X_train_2 = pd.read_csv("/root/WorkPlace/black_plus_csv/X_train_2.csv", index_col=0).values
# y_train_2 = pd.read_csv("/root/WorkPlace/black_plus_csv/y_train_2.csv", index_col=0).values
...
model.add(tf.keras.layers.LSTM(128, activation='tanh', return_sequences=True, input_shape=(100,1)))
...
model.save("/root/WorkPlace/model/lstm_tran.h5")